...
IF NOT EXISTS (SELECT * FROM sys.sql_logins WHERE name = 'sqlpaluser')
BEGIN
    CREATE LOGIN [sqlpaluser] WITH PASSWORD = 'sqlpass', CHECK_POLICY = OFF;
    ALTER SERVER ROLE [sysadmin] ADD MEMBER [sqlpaluser];
END
GO

CREATE DATABASE sqlpal;
GO
USE sqlpal;
GO
CREATE USER sqlpaluser FOR LOGIN sqlpaluser;
GO 
