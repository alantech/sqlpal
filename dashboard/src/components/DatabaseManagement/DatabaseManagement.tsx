...
export function DatabaseManagement() {
  return (
    <HBox customStyles='grid grid-cols-3 sm:text-md sm:grid-cols-10 sm:grid-rows-2 xl:grid-rows-1'>
      ...
      <HBox customStyles='row-start-2 col-span-auto sm:row-start-auto sm:col-span-4 sm:col-start-7 xl:col-span-auto'>
      {/* <HBox customStyles='col-start-10 row-start-2 col-span-auto sm:row-start-auto sm:col-span-4 sm:col-start-7 xl:col-span-2'> */}
        <DatabaseActions />
      </HBox>
    </HBox>
  );
